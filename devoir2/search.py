...
class Node:
    ...
    def __init__(self, state, parent=None, action=None, path_cost=0,i=1):
    ...
    def child_node(self, problem, action):
        ...
        next_node = Node(next_state, self, action, problem.path_cost(self.path_cost, self.state, action, next_state),self.i)
        return next_node
